...
Contains reponsive UI with *footer*, *login form*, _dynamic_ *header & sidebar* components.

## Demo

[Github](https://github.com/moniz1/hms-project),  live demo [Stackblitz](https://stackblitz.com/edit/hms-project)

## Installation

1. Open terminal point to your angular project run `npm i hms-lib`.
1. This lib has bootstrap as an dependency so you must run `npm i bootstrap` and `npm i jquery` if your project misses.
1. Import the module to your root module.
